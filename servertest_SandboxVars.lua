SandboxVars = {
    ...
    BecomeDesensitized = {
        ...
        MinimumZombieKills = 50,
        -- Mínimo=1 Máximo=10000 Por defecto=2000
        MaximumZombieKills = 100,
        ConsiderTraits = true,
        ConsiderOccupations = true,
    },
    ScientificChemistry = {
        -- Mínimo=2 Máximo=48 Por defecto=7
        Frequency = 7,
        -- Mínimo=72 Máximo=2400 Por defecto=240
        Cold = 240,
        -- Mínimo=0 Máximo=100000 Por defecto=5000
        Xcell = 5000,
        -- Mínimo=0 Máximo=1000 Por defecto=200
        Psycho = 200,
        -- Mínimo=0 Máximo=1000 Por defecto=100
        Mentats = 100,
        -- Mínimo=0 Máximo=1000 Por defecto=150
        Buffout = 150,
    },
}
